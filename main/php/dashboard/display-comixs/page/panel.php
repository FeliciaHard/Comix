                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-center mb-4">
                            <label class="card p-2 pl-4 pr-4 rounded-pill" style="background-color: #7209b7; border: none;">
                                <h1 class="h3 mb-0 text-center text-light fw-semibold"><?= $rowPage['name_comix']; ?></h1>
                            </label>
                        </div>

                        <div class="col-xl-8 col-lg-13">
                            <?php include_once 'dis-page.php'; ?>
                        </div>

                        <div class="col-xl-4 col-lg-13">
                            <?php include_once 'search-inpage.php'; ?>
                        </div>
